  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/HomeApp': (context) => const HomeAppMain(),
      },
      home: const HomeApp(),
    );
  }
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(
                          shape: BoxShape
                              .circle, // AGAR GAMBAR PROFILE PICTURE MENJADI LINGKARAN
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: const ShapeDecoration(
                          ...
                          shape: RoundedRectangleBorder(
                            side:
                                BorderSide(width: 1, color: Color(0xFFF1F5F8)),
                          ),
                        ),
                      ),
                    ),
                    ...
                    Positioned(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(
                              width: 108), // LETAK GAMBAR HEART 2 (wishlist)
                          Container(
                            width: 50,
                            height: 50,
                            decoration: const BoxDecoration(
                          ...
                          const SizedBox(
                              width: 108), // LETAK GAMBAR SHOPPING CART
                          Container(
                            width: 50,
                            height: 50,
                            decoration: const BoxDecoration(
